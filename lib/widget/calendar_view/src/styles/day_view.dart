import 'package:appointments/widget/calendar_view/src/styles/zoomable_header_widget.dart';
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (dayViewStyle.backgroundRulesColor != null) {
      ...
      for (HourMinute time in sideTimes) {
        ...
        canvas.drawLine(
            Offset(0, topOffset), Offset(size.width, topOffset), Paint()..color = dayViewStyle.backgroundRulesColor!);
      }
    }
  }
