...
import 'package:appointments/widget/calendar_view/src/controller/week_view.dart';
import 'package:appointments/widget/calendar_view/src/event.dart';
import 'package:appointments/widget/calendar_view/src/styles/day_bar.dart';
import 'package:appointments/widget/calendar_view/src/styles/day_view.dart';
import 'package:appointments/widget/calendar_view/src/styles/hours_column.dart';
import 'package:appointments/widget/calendar_view/src/styles/week_view.dart';
import 'package:appointments/widget/calendar_view/src/utils/builders.dart';
import 'package:appointments/widget/calendar_view/src/utils/hour_minute.dart';
import 'package:appointments/widget/calendar_view/src/utils/scroll.dart';
import 'package:appointments/widget/calendar_view/src/utils/utils.dart';
import 'package:appointments/widget/calendar_view/src/widgets/day_bar.dart';
import 'package:appointments/widget/calendar_view/src/widgets/hours_column.dart';
import 'package:appointments/widget/calendar_view/src/widgets/zoomable_header_widget.dart';
...
class _WeekViewState extends ZoomableHeadersWidgetState<WeekView> {
  ...
  bool get shouldScrollToInitialTime =>
      super.shouldScrollToInitialTime && dayViewWidth != null && initialTimeDateIndex != null;
  ...
  void scrollToInitialTime() {
    ...
    horizontalScrollController!
        .jumpTo(math.min<double>(leftOffset, horizontalScrollController!.position.maxScrollExtent));
  }
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              physics: widget.inScrollableWidget
                  ? MagnetScrollPhysics(itemSize: dayViewWidth! + widget.style.dayViewSeparatorWidth)
