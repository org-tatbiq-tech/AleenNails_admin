...
class UserSecureStorage {
  ...
  static Future deleteUserPassword() async =>
      await _storage.delete(key: _keyUserPassword);

  static Future setAutoLogin(String autoLogin) async => await _storage.write(
        key: _keyUserAutoLogin,
        value: autoLogin,
      );

  static Future<String?> getAutoLogin() async =>
      await _storage.read(key: _keyUserAutoLogin);

  static Future deleteAutoLogin() async =>
      await _storage.delete(key: _keyUserAutoLogin);
}
